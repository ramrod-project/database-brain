...
_LOG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='TimeStamp', full_name='brain.Log.TimeStamp', index=1,
      number=2, type=2, cpp_type=6, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='LogLevel', full_name='brain.Log.LogLevel', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='SrcHost', full_name='brain.Log.SrcHost', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='SrcContainer', full_name='brain.Log.SrcContainer', index=5,
...
_LOG.fields_by_name['msg'].message_type = _LOG_MESSAGE
