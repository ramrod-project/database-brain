...
_BINARY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Part', full_name='brain.Binary.Part', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Parts', full_name='brain.Binary.Parts', index=5,
